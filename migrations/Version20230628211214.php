 ...
 */
final class Version20230628211214 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categories (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, name VARCHAR(64) NOT NULL, slug VARCHAR(64) NOT NULL, INDEX IDX_3AF34668F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE questions (id INT AUTO_INCREMENT NOT NULL, best_answer_id INT DEFAULT NULL, author_id INT NOT NULL, title VARCHAR(150) NOT NULL, slug VARCHAR(150) NOT NULL, content LONGTEXT NOT NULL, created_date DATETIME NOT NULL, last_modified_date DATETIME NOT NULL, UNIQUE INDEX UNIQ_8ADC54D5B6DEA817 (best_answer_id), INDEX IDX_8ADC54D5F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_data (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_D772BFAAA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
